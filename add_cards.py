...
cards = """        <a href="recipes/sticky-sausage-pepper-kebabs-homemade-chips.html" class="recipe-card" data-cat="Fakeaways">
...
anchor = '<div class="recipe-grid" id="recipeGrid">'
if anchor in content:
    content = content.replace(anchor, anchor + "\n" + cards)
    with open(file_path, "w", encoding="utf-8") as f:
        f.write(content)
    print("SUCCESS: 7 cards added at the TOP of the grid")
else:
